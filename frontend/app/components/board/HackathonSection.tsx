    ...
    return (
        <div className="flex flex-col gap-2 sm:gap-4 py-1 sm:py-2 overflow-hidden">
            <div className="flex items-center justify-between px-4 sm:px-1">
                ...
                {hasMore && (
                    <button
                        ...
                        className="text-[10px] sm:text-xs font-medium text-blue-600 dark:text-blue-400 hover:underline"
                    >
            ...
            <div className="relative group/slider overflow-hidden">
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 px-4 sm:px-1 snap-x snap-mandatory scrollbar-hide">
