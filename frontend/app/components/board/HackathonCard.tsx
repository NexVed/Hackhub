...
function HackathonCard({ hackathon, onRegister }: HackathonCardProps) {
    ...
    return (
        <div
            onClick={handleClick}
            className="group relative flex-none w-[230px] max-w-[calc(100vw-2rem)] sm:w-[320px] bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-2.5 sm:p-4 cursor-pointer transition-all duration-200 hover:shadow-lg hover:border-zinc-300 dark:hover:border-zinc-700 hover:-translate-y-1 snap-start"
        >
