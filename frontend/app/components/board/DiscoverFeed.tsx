...
export default function DiscoverFeed({ onRegister }: DiscoverFeedProps) {
    ...
    return (
        <div className="flex flex-col gap-6 sm:gap-8 px-0 sm:px-6 py-4 sm:py-8 w-full max-w-[1600px] mx-auto">
            {/* Header */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 sm:px-0 pb-4 sm:pb-6 border-b border-zinc-200 dark:border-zinc-800">
